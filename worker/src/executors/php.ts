...
export const executePHP = (
  ...
  return new Promise((resolve) => {
    ...
    const filePath = path.join(workspace, "main.php");
    ...
    const command =
      `docker run --rm --network=none --memory=256m --cpus=1 -i -v "${workspace}:/workspace" php:8.3-cli sh -c "php /workspace/main.php < /workspace/input.txt"`;
