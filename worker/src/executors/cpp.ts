...
export const executeCpp = (
  ...
  return new Promise((resolve) => {
    ...
    const command =
      `docker run --rm --network=none --memory=256m --cpus=1 -i -v "${workspace}:/workspace" gcc:latest sh -c "g++ /workspace/main.cpp -o /workspace/main && /workspace/main < /workspace/input.txt"`;
